...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
  <div class="form-group row ">
    {!! Form::label('subcategory_id', 'subcategory',['class' => 'col-3 control-label text-right']) !!}
    <div class="col-9">
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}}" ><i class="fa fa-save"></i> {{trans('lang.save')}} Child Category</button>
