...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row" style="margin-left:24%;">
        <div class="col-md-12">
            <label class="col-3 control-label text-right" style="margin-left:-27%;">Category</label>
            <select name="category_id" class="form-control SlectBox"

             onclick="console.log($(this).val())"onchange="console.log('change is category')" style="margin-top: -7%; margin-bottom: 35px;}">
            ...
            <div style="margin-top:-30px;margin-bottom:20px" class="form-text text-muted">Insert Category</div>
        </div>
        
    <div class="col-md-12">
        <label style="margin-left: -27%;">SubCategory</label>
        <select id="subcategory" name="sub_id" class="form-control" style="margin-top: -7%; margin-bottom: 35px;">
        </select>
        <div style="margin-top: -30px" class="form-text text-muted">Insert SubCategory</div>
    </div>

    <div class="col-md-12">
        <label class="col-3 control-label text-right" style="margin-left:-27%;">Child<br>Category</label>
        <select name="category_id" class="form-control SlectBox" style="margin-top: -7%; margin-bottom: 35px;">
            <option value="" selected disabled>ChildCategory</option>
            @foreach ($childcategories as $child)
                <option value="{{$child->id}}">{{$child->name}}</option>
                @endforeach
        </select>
        <div style="margin-top:-32px;margin-bottom:-6px" class="form-text text-muted">Insert ChildCategory</div>
    </div>
</div>
