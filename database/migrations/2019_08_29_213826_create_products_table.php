...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->text('ingredients')->nullable()->default('ingred');
            ...
            $table->foreign('sub_id')->references('id')->on('subcategories')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('child_id')->references('id')->on('child_category')->onDelete('cascade')->onUpdate('cascade');
        });
    }
